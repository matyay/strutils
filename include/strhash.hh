#ifndef STRUTILS_STRHASH_HH
#define STRUTILS_STRHASH_HH
...
/// Computes a compile-time hash for a string.
template <size_t len>
constexpr uint32_t hash(const char (&str)[len]) {
    return crc32<len - 2>(str) ^ 0xFFFFFFFF;
}
